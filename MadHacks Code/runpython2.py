...
flag=0
oicurl = "https://MEDISQUADOIC-apaccpt01.integration.ocp.oraclecloud.com:443/ic/api/integration/v1/flows/rest/M_NOTIFY/1.0/notify"
previous_status="LOW"
while 1:
	x=ser.readline()
	if x[0] == 'a':
	...
	if val1 and val2:
		...
		if(flag>0):	
			...
			response= requests.post(oicurl, json=data_oic, auth=('hack05','Oracle#1234567'))
			print(response)
			flag=0
